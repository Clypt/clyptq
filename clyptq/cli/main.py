...
def main():
    ...
    data_parser.add_argument("--futures", action="store_const", const="futures", dest="market", help="Shortcut for --market futures")
    data_parser.add_argument("--spot", action="store_const", const="spot", dest="market", help="Shortcut for --market spot")
