...
def main():
    ...
    if args.command == "data":
        from clypt.cli.commands.data import handle_data
        handle_data(args)
    elif args.command == "backtest":
        from clypt.cli.commands.backtest import handle_backtest
        handle_backtest(args)
    elif args.command == "paper":
        from clypt.cli.commands.paper import handle_paper
        handle_paper(args)
    elif args.command == "live":
        from clypt.cli.commands.live import handle_live
        handle_live(args)
